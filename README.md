...
![App Preview](https://github.com/PriyanshuRai2108/Streamlit_Titanic_Survival/blob/main/image.png)
...
```bash
git clone https://github.com/PriyanshuRai2108/Streamlit_Titanic_Survival.git
